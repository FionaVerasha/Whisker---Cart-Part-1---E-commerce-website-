...
<h1 class="text-4xl font-bold underline text-gray-800 rounded-lg p-10 text-center">ACCESSORIES</h1>
<?php
include '../includes/db.php'; // Include the database connection

// Fetch products in the "Cats" category
$category_id = 3; // Assuming "Cats" has category_id = 2. Update this ID if necessary.
